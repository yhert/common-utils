...
import com.yhert.project.yfw.service.AbstractService;
...
public class ${javaname}ServiceImpl extends AbstractService<${javaname}ServiceImpl, ${javaname}Dao, ${javaname}> implements ${javaname}Service {
	/**
	 * 查询出一个数据
	 * 
